export const translations = {
    ko: {
        ...
        footer: {
            ...
            report: '오류 제보',
            language: 'English',
            company: 'Next Engine Idea Lab (내일)',
            ceo: '대표자명: OOO',
            address: '주소: 서울특별시 마포구 OOO',
            phone: '유선번호: OOO-OOOO',
            businessNumber: '사업자등록번호: OOO-OO-OOOO',
            email: '메일: OOOO@nextengine.lab',
            copyright: 'Next Engine Idea Lab. All rights reserved.',
        },
    },
    en: {
        // Header
        ...
        footer: {
            ...
            report: 'Report Bug',
            language: '한국어',
            company: 'Next Engine Idea Lab',
            ceo: 'CEO: OOO',
            address: 'Address: Seoul, Mapo-gu, OOO',
            phone: 'Phone: OOO-OOOO',
            businessNumber: 'Business No: OOO-OO-OOOO',
            email: 'Email: OOOO@nextengine.lab',
            copyright: 'Next Engine Idea Lab. All rights reserved.',
        },
    },
};
